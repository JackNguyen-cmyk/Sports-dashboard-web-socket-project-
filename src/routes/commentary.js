...
// `db` is a parameter for the same reason as in matches.js: so the router can
// be exercised against a fake without a live database.
export function createCommentaryRouter({ db }) {
